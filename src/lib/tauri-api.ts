...
export const ERROR_ZH: Record<string, string> = {
  ...
  "error.backup.tool_not_found": "未找到官方备份工具，请安装 mysqldump/mysql、pg_dump/pg_restore 或 sqlite3，或在对话框指定路径",
  "error.backup.table_scope_unsupported": "SQLite 官方备份只能整库导出，单表请用内置 dump 导出",
