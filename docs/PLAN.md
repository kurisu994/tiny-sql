...
> **v0.4.0-rc1 已发布（2026-08-22，提交 `dbae167`，tag `v0.4.0-rc1`）**：四平台 prerelease（无 `latest.json`，不影响 v0.3.0 用户）。剩全平台下载安装验收与 V4-T8.2 一周试用 → 正式发布（V4-CP5）。
...
| 检查点 | 时机 | 通过标准 | 状态 |
|---|---|---|---|
| **V4-CP0** 启动准入 | 开工前 | §V4.1 全部完成 | ✅ 2026-08-22 |
...
| **V4-CP5** 发布 | Week 8 末 | 双 driver dogfood + P0/P1 清零 + RC 安装通过 | ⏳ 待 V4-T8.1/T8.2 用户实测 |
