...
**本轮：发布 v0.7.0（2026-08-24）**——`just check` 全绿后 `just release v0.7.0`，提交 `d2d3f5c`，tag 已推送。稳定版从 v0.3.0 一次升到 v0.7.0。等 GitHub Actions 四平台资产与 `latest.json`。

**前一轮：立项 v0.8 草案（2026-08-24）**——主题「防连错与查询补齐」：P0 FR-270 只读开关；P1 FR-271–275。双向同步 / BI / AI 挂 v0.9+。功能未开工。
...
1. 看 GitHub Actions `v0.7.0` 四平台是否成功，核对 `latest.json`。
2. 从 v0.3.0 应用内检查更新到 v0.7.0。
3. v0.8 等你确认后再开工。
