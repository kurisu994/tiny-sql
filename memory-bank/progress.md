...
| v0.2 | 🚧 发布前置就绪 | Week 1-7 开发与自动化门禁均完成；2026-08-19 真实环境验收（T3.4/T4.3/T7.x 链路/T8.1）全部通过，V2-CP2/CP3/CP4 关闭；2026-08-20 发布 `v0.2.0-rc1`（发布提交 `64787d8`，Release run `32322049995` 全绿）；PG 15/18 双端点回归、RC 下载验收完成，T8.2 由用户确认提前关闭；仅剩 `just release v0.2.0` |
