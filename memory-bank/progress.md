...
| v0.2 | 🚧 RC 已发布 | Week 1-7 开发与自动化门禁均完成；2026-08-19 真实环境验收（T3.4/T4.3/T7.x 链路/T8.1）全部通过，V2-CP2/CP3/CP4 关闭；2026-08-20 发布 `v0.2.0-rc1`（发布提交 `64787d8`，Release run `32322049995`）；剩 RC 下载验收、PostgreSQL 版本矩阵回归、T8.2 RC 试用与正式版发布 |
